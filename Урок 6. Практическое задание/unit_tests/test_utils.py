...
class TestSocket:
    ...
    требует словарь, который будет прогонятся через тестовую функцию
    """
    ...
    def send(self, message_to_send):        # из json-объекта делаем байты и шлём
        """
    ...
    def recv(self, max_len):                # из байтов делаем json-объект
        """
